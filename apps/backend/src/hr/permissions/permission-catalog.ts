...
export const HR_PERMISSION_CATALOG: PermissionDef[] = [
  ...
  { key: 'vendors.view', groupLabel: 'Vendors', description: 'View vendor directory and applications' },
  { key: 'vendors.create', groupLabel: 'Vendors', description: 'Create internal or public vendor records' },
  { key: 'vendors.edit', groupLabel: 'Vendors', description: 'Edit vendor profiles and offerings' },
  {
    key: 'vendors.review',
    groupLabel: 'Vendors',
    description: 'Review applications, approve listing, request clarification',
    isCritical: true,
  },
  {
    key: 'vendors.verify',
    groupLabel: 'Vendors',
    description: 'Complete BuildMyHouse verification checks',
    isCritical: true,
  },
  {
    key: 'vendors.suspend',
    groupLabel: 'Vendors',
    description: 'Suspend or restore vendor listings',
    isCritical: true,
  },
  {
    key: 'vendors.documents.view',
    groupLabel: 'Vendors',
    description: 'View private vendor verification documents',
    isCritical: true,
  },
  { key: 'vendors.notes.manage', groupLabel: 'Vendors', description: 'Manage private vendor notes and activity' },

  { key: 'professionals.view', groupLabel: 'Professionals', description: 'View professional directory and procurement records' },
  { key: 'professionals.create', groupLabel: 'Professionals', description: 'Create professional listings' },
  { key: 'professionals.edit', groupLabel: 'Professionals', description: 'Edit professional listings, procurement and engagements' },
  {
    key: 'professionals.review',
    groupLabel: 'Professionals',
    description: 'Review applications, claims and listing status',
    isCritical: true,
  },
  {
    key: 'professionals.verify',
    groupLabel: 'Professionals',
    description: 'Record and check professional credentials',
    isCritical: true,
  },
