    ...
    <View className="flex-1 bg-white">
      <View className="pt-10 px-5 pb-2 md:pt-14 md:px-6 md:pb-4">
        ...
        <View className="flex-col gap-2">
          <TouchableOpacity
            onPress={() => {
              trackWebEvent('seo_renovation_hub_hero_primary', { page: 'renovation/nigeria' });
              router.push(c.hero.primaryCta.href as any);
            }}
          ...
          <TouchableOpacity
            onPress={() => {
              trackWebEvent('seo_renovation_hub_hero_secondary', { page: 'renovation/nigeria' });
              router.push(c.hero.secondaryCta.href as any);
            }}
