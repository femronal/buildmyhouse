export const ukRenovateParentsHousePageContent = {
  seo: {
    title: "Renovate Your Parents’ House in Nigeria from the UK | BuildMyHouse",
    description:
      "A practical guide for UK-based Nigerians who want to renovate their parents’ house in Nigeria with more control, clearer stage tracking, better payment discipline, and less family stress.",
    canonical: "https://buildmyhouse.app/diaspora/uk/renovate-parents-house",
    robots: "index, follow",
  },

  hero: {
    eyebrow: "DIASPORA (UK)",
    title: "Renovate Your Parents’ House in Nigeria from the UK — Without Losing Control",
    description:
  ...
  coverImage: {
    ...
    alt: "Family home renovation planning scene for a diaspora homeowner managing a property from abroad",
  },

  hook: {
    title: "This Is Not Just a Renovation. It Is a Responsibility.",
    paragraphs: [
  ...
  quickAnswer: {
    title: "How to Renovate Your Parents’ House from the UK Safely",
    items: [
  ...
  story: {
    title: "The Story Many UK-Based Nigerians Already Know",
    paragraphs: [
  ...
  whyThisGoesWrong: {
    title: "Why Renovating a Parents’ House from the UK Goes Wrong So Easily",
    paragraphs: [
  ...
  parentsHomeReality: {
    title: "Parents’ Homes Need a Different Kind of Renovation Planning",
    paragraphs: [
  ...
  whatToPlan: {
    title: "What You Need to Plan Before Work Starts",
    items: [
  ...
  stageControl: {
    title: "Stage Control Matters Even More When You Are Abroad",
    paragraphs: [
  ...
  familyDynamics: {
    title: "Family Help Is Useful. Family-Only Control Is Risky.",
    paragraphs: [
  ...
  ukSpecificAngle: {
    title: "Why This Feels Different When You Are in the UK",
    paragraphs: [
  ...
  buildMyHouseAngle: {
    cardTitle: "Why UK-Based Homeowners Choose BuildMyHouse",
    cardItems: [
    ...
    sectionTitle: "Why BuildMyHouse Is Safer for Renovating Your Parents’ House from the UK",
    paragraphs: [
  ...
  leadMagnet: {
    title: "Download the Remote Renovation Scope Worksheet",
    description:
      "Use the worksheet to define the work clearly before the project begins stretching through pressure, assumptions, and random approvals.",
    primaryCta: {
  ...
  faq: {
    ...
    items: [
      {
        question: "Can I really renovate my parents’ house in Nigeria while living in the UK?",
        answer:
      ...
      {
        question: "What is the biggest mistake UK-based homeowners make in this kind of renovation?",
        answer:
          "One of the biggest mistakes is approving money too early because of emotion, family pressure, or vague updates instead of stage clarity.",
      },
      {
        question: "Should my parents stay in the house during the renovation?",
        answer:
          "It depends on the kind of work. Occupied-home renovation needs more careful sequencing, and some stages may be easier or safer if certain spaces are cleared temporarily.",
      },
      {
        question: "Can family supervise this alone?",
        answer:
          "Family can help, but family-only supervision is usually not enough for strong control, documentation, and payment discipline.",
      },
      {
  ...
  cta: {
    title: "Renovate your parents’ house from the UK with more structure and less stress.",
    description:
  ...
  faqSchema: {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Can I really renovate my parents’ house in Nigeria while living in the UK?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. But it works best when the renovation is broken into clear stages, the scope is properly defined, and payment does not move casually ahead of proof.",
        },
      },
      {
        "@type": "Question",
        name: "What is the biggest mistake UK-based homeowners make in this kind of renovation?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "One of the biggest mistakes is approving money too early because of emotion, family pressure, or vague updates instead of stage clarity.",
        },
      },
      {
        "@type": "Question",
        name: "Can family supervise this alone?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Family can help, but family-only supervision is usually not enough for strong control, documentation, and payment discipline.",
        },
      },
    ],
  },
