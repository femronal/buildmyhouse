export const renovationPermitLagosRepairVsRenovationPageContent = {
  seo: {
  ...
  hero: {
    eyebrow: "LAGOS RENOVATION GUIDE",
    title: "Renovation vs Repair in Lagos: When You Need More Caution",
    description:
    ...
    primaryCta: {
      label: "Download the Permit Starter Checklist",
  ...
  coverImage: {
    ...
    alt: "Home renovation work in progress with tools, structure, and interior changes",
  },

  hook: {
    title: "The Problem Starts When Every Kind of Work Is Called 'Just Renovation'",
    paragraphs: [
  ...
  quickAnswer: {
    title: "How to Think About Repair vs Renovation in Lagos",
    items: [
  ...
  officialMeaning: {
    title: "What Lagos Building Control Says in Plain English",
    paragraphs: [
  ...
  simpleExamples: {
    title: "What Usually Feels More Like Repair or Finish Replacement",
    items: [
      "Repainting walls",
      "Changing tiles",
  ...
  cautionExamples: {
    title: "What Should Make You More Careful",
    items: [
  ...
  diasporaProblem: {
    title: "Why This Becomes More Dangerous When You Are Abroad",
    paragraphs: [
  ...
  practicalTest: {
    title: "A Practical Test You Can Use",
    paragraphs: [
  ...
  stageControl: {
    title: "Do Not Let the Next Stage Move Casually",
    paragraphs: [
  ...
  lagosActionGuide: {
    title: "What You Should Do Next if You Are Renovating in Lagos",
    steps: [
      {
        heading: "If the work is still light and finish-focused",
        items: [
      ...
      {
        heading: "If the work is becoming more serious",
        items: [
      ...
      {
        heading: "If the work now feels like restructuring or remodelling",
        items: [
  ...
  governmentLinks: {
    title: "Where to Learn More From Official Lagos Sources",
    links: [
      {
        label: "Lagos planning permit information",
        href: "https://epp.lagosstate.gov.ng/Home/AboutPlanningPermit",
      },
      {
        label: "Lagos building control information",
        href: "https://epp.lagosstate.gov.ng/Home/BuildingControl",
      },
      {
      ...
      {
        label: "LASBCA FAQ",
        href: "https://lasbca.lagosstate.gov.ng/faq/",
      },
      {
        label: "Lagos renovation permit route",
  ...
  buildMyHouseAngle: {
    ...
    sectionTitle: "Why BuildMyHouse Is Useful in Situations Like This",
    paragraphs: [
  ...
  leadMagnet: {
    title: "Download the Lagos Permit Starter Checklist",
    description:
  ...
  publicDemoTeaser: {
    title: "See How Stage Control Helps You Decide Better",
    paragraphs: [
  ...
  faq: {
    ...
    items: [
      {
        question:
          "What is renovation according to Lagos building control guidance?",
        answer:
      ...
      {
        question:
          "If I am only changing tiles, fittings, windows, or painting, is that the same as restructuring the building?",
        answer:
          "No. Those examples fit more closely with the finish-replacement kind of work LASBCA describes under renovation, not full restructuring.",
      },
      {
        question:
          "Why should I be more careful when renovating from abroad?",
        answer:
          "Because distance makes it easier for people to simplify the story and keep the work moving before you fully understand whether the scope has become bigger than surface repair.",
      },
      {
        question: "How does BuildMyHouse help in situations like this?",
        answer:
          "BuildMyHouse helps bring stage control, communication, payment discipline, and project visibility into one structured workflow, which is useful when the work needs to be questioned before moving forward.",
      },
    ],
  },
  ...
  cta: {
    title: "Do not let a Lagos renovation grow into confusion.",
    description:
    ...
    secondary: {
      label: "Download the Permit Checklist",
      href: "/downloads/lagos-permit-starter-checklist",
    },
  },
  ...
  faqSchema: {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What is renovation according to Lagos building control guidance?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "LASBCA says renovation is repair work involving replacement of finishes on a building without changing or altering the structural arrangement.",
        },
      },
      {
        "@type": "Question",
        name: "What is remodelling according to LASBCA?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "LASBCA says remodelling is the general restructuring of a building to change it from its original design, and that a new design must be prepared for the proposed structure.",
        },
      },
      {
        "@type": "Question",
        name: "Why should I be more careful when renovating from abroad?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Because distance makes it easier for people to simplify the story and keep the work moving before you fully understand whether the scope has become bigger than surface repair.",
        },
      },
    ],
  },
