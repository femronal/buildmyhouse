export const lagosPermitStarterChecklistDownloadPageContent = {
  seo: {
    ...
    canonical: "https://buildmyhouse.app/downloads/lagos-permit-starter-checklist",
    robots: "index, follow",
  },

  hero: {
    eyebrow: "FREE DOWNLOAD",
    title: "Download the Lagos Permit Starter Checklist for Nigerians Abroad",
    description:
    ...
    primaryCta: {
      ...
      href: "/pdfs/Lagos-Permit-Starter-Checklist-BMH.pdf",
      download: true,
    },
    secondaryCta: {
  ...
  coverImage: {
    ...
    alt: "Modern city construction and planning scene representing Lagos building permits and compliance",
  },

  trustNote: {
    title: "No signup. No friction. Just the checklist.",
    paragraphs: [
      "This is an instant download because trust comes first.",
  ...
  whoItsFor: {
    title: "Who this checklist is for",
    items: [
  ...
  whatItHelpsWith: {
    title: "What this checklist helps you do",
    items: [
  ...
  whatsInside: {
    ...
    sections: [
      {
        heading: "Project type checkpoint",
        text:
  ...
  whyThisMatters: {
    title: "Why this checklist matters more than many people realize",
    paragraphs: [
  ...
  buildMyHouseFit: {
    title: "Why BuildMyHouse created this",
    paragraphs: [
  ...
  previewCallout: {
    title: "One rule from the checklist that every diaspora homeowner should remember",
    quote:
      "If the current stage is not clearly ready, do not proceed as though the next stage is safe.",
  },

  relatedResources: {
    title: "Helpful resources after you download",
    links: [
      {
  ...
  finalCta: {
    title: "When you are ready, build in Lagos with more control",
    description:
  ...
  faq: {
    ...
    items: [
      {
        question: "Is this checklist really free?",
        answer:
      ...
      {
        question: "Do I need to sign up before downloading it?",
        answer:
          "No. This checklist is an instant download because the goal is to help you first.",
      },
      {
        question: "Is this mainly for new buildings or renovation too?",
        answer:
          "It is mainly for building projects in Lagos, but it also includes a renovation caution section because some renovation work can still raise compliance questions.",
      },
      {
        question: "Will this make me a legal expert on Lagos permits?",
        answer:
          "No. It is a plain-English action guide, not a legal memo. It helps you ask better questions and know when to slow down and verify more.",
      },
      {
        question: "What should I do after using this checklist?",
        answer:
          "Use it to get clearer on your project readiness, then move into a more structured workflow where stages, communication, and payment logic are easier to control.",
      },
    ],
  },
  ...
  faqSchema: {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "Is this checklist really free?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. It is a free instant download for Nigerians abroad who want to understand Lagos building compliance more clearly before work starts.",
        },
      },
      {
        "@type": "Question",
        name: "Do I need to sign up before downloading it?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "No. This checklist is an instant download because the goal is to help you first.",
        },
      },
      {
        "@type": "Question",
        name: "Is this mainly for new buildings or renovation too?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "It is mainly for building projects in Lagos, but it also includes a renovation caution section because some renovation work can still raise compliance questions.",
        },
      },
    ],
  },
