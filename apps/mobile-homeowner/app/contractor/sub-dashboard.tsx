  ...
  return (
    <View className="flex-1 bg-[#0A1628]">
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        {/* Services Offered */}
        <View className="px-6 mb-6">
          <Text className="text-white text-lg mb-3" style={{ fontFamily: 'Poppins_700Bold' }}>Services Offered</Text>
        ...
        <View className="px-6 mb-6">
          <View className="flex-row items-center justify-between mb-4">
            <Text className="text-white text-lg" style={{ fontFamily: 'Poppins_700Bold' }}>My Jobs</Text>
                ...
                <View className="p-4">
                  <View className="flex-row justify-between items-start mb-2">
                    <View className="flex-1">
                      <Text className="text-white text-lg" style={{ fontFamily: 'Poppins_700Bold' }}>{job.projectName}</Text>
                      <Text className="text-gray-400 text-sm" style={{ fontFamily: 'Poppins_400Regular' }}>GC: {job.gcName}</Text>
                    </View>
      ...
      <View className="flex-row bg-[#0A1628] border-t border-blue-900 px-6 py-4">
        <TouchableOpacity className="flex-1 items-center">
          <Briefcase size={24} color="#F97316" strokeWidth={2} />
          <Text className="text-orange-400 text-xs mt-1" style={{ fontFamily: 'Poppins_500Medium' }}>Jobs</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-1 items-center">
          <MessageCircle size={24} color="#6B7280" strokeWidth={2} />
          <Text className="text-gray-500 text-xs mt-1" style={{ fontFamily: 'Poppins_500Medium' }}>Messages</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-1 items-center">
