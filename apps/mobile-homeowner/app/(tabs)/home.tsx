                ...
                <View className="p-3">
                  ...
                  <View className="flex-row justify-between mb-2">
                    <View>
                      ...
                      <Text className="text-black text-base" style={{ fontFamily: 'Poppins_600SemiBold' }}>{investment.roi}</Text>
                    </View>
                    <View>
                ...
                <View className="bg-gray-50 rounded-2xl p-4 mb-4 border border-gray-200">
                  <View className="flex-row justify-between mb-3">
                    <View>
                      ...
                      <Text className="text-black text-xl" style={{ fontFamily: 'Poppins_600SemiBold' }}>{selectedInvestment?.roi}</Text>
                    </View>
                    <View>
                      <Text className="text-gray-500 text-xs" style={{ fontFamily: 'Poppins_400Regular' }}>Duration</Text>
                      <Text className="text-black text-xl" style={{ fontFamily: 'Poppins_600SemiBold' }}>{selectedInvestment?.duration}</Text>
                    </View>
                  </View>
