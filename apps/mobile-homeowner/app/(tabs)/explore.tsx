      ...
      <View className="px-6 mb-4">
        <View className="flex-row items-center">
          <TouchableOpacity 
            ...
            className="flex-1 bg-gray-100 rounded-2xl px-4 py-4 flex-row items-center mr-3"
          >
            <Search size={20} color="#737373" strokeWidth={2} />
            <Text className="flex-1 ml-3 text-gray-500" style={{ fontFamily: 'Poppins_400Regular' }}>
              Search designs, materials, contractors...
            </Text>
          </TouchableOpacity>
          <TouchableOpacity 
