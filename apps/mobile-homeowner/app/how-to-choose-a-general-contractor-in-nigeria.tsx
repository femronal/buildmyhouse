...
export default function HowToChooseGeneralContractorNigeriaPage() {
  const content = getSeoPageContent('howToChooseGeneralContractorNigeria');
  useWebSeo({
    title: content.title,
  ...
  return (
    <SeoLandingPage
      ...
      coverImageSource={{ uri: SEO_LANDING_COVERS.contractor }}
