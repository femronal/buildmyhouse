...
export default function MistakesDiasporaBuildingPage() {
  const content = getSeoPageContent('mistakesNigeriansDiasporaBuilding');
  useWebSeo({
    title: content.title,
  ...
  return (
    <SeoLandingPage
      ...
      coverImageSource={{ uri: SEO_LANDING_COVERS.mistakes }}
